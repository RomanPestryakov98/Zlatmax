(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-block__slider")) new swiper_core_Swiper(".main-block__slider", {
            ...
            pagination: {
                el: ".control-slider-main__pagination",
                clickable: true
            },
            on: {
                init: swiper => {
        ...
        if (document.querySelector(".slider-products .products-slider")) new swiper_core_Swiper(".slider-products .products-slider", {
            modules: [ Navigation, Pagination, Autoplay ],
            slidesPerView: 1,
            spaceBetween: 30,
            autoplay: {
            ...
            pagination: {
                el: ".slider-products .pagination_gray",
                clickable: true,
                dynamicBullets: true
            },
            breakpoints: {
        ...
        if (document.querySelector(".new-products .products-slider_min")) new swiper_core_Swiper(".new-products .products-slider_min", {
            modules: [ Navigation, Pagination, Autoplay ],
            slidesPerView: 1,
            spaceBetween: 20,
            pagination: {
        ...
        if (document.querySelector(".our-articles")) new swiper_core_Swiper(".our-articles__slider", {
            modules: [ Navigation ],
            slidesPerView: 1,
            spaceBetween: 30,
            breakpoints: {
    ...
    da.init();
    const blocks = document.querySelectorAll(".sub-menu-catalog__block");
    if (blocks.length) blocks.forEach((block => {
        const categories = block.querySelectorAll(".sub-menu-catalog__category");
        block.classList.add(`sub-menu-catalog__block_${categories.length}`);
    }));
    window["FLS"] = true;
    isWebp();
    spollers();
